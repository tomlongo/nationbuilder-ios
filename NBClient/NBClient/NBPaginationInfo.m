...
- (NSDictionary *)queryParameters
{
    ...
    if (self.isLegacy) {
        ...
        if (self.currentDirection == NBPaginationDirectionNext && dictionary[NBClientPaginationNextLinkKey] && ![dictionary[NBClientPaginationNextLinkKey] isKindOfClass:[NSNull class]]) {
            components = [NSURLComponents componentsWithString:dictionary[NBClientPaginationNextLinkKey]];
        } else if (self.currentDirection == NBPaginationDirectionPrevious && dictionary[NBClientPaginationPreviousLinkKey] && ![dictionary[NBClientPaginationPreviousLinkKey] isKindOfClass:[NSNull class]]) {
